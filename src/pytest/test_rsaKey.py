...
def test_toJson(rsa_key):
    assert rsa_key.toJson() == '{"n": "d71c66013eaee4852fe7797e4e2aeeed", "e": "10001", "d": "23caa95c4eaa3a02730f965a8a3903d1"}'
...
def test_fromJson(empty_rsa_key):
    ...
    assert empty_rsa_key.key == {'n': mpz(98554181312648717508777189852108668149), 'e': mpz(65537), 'd': mpz(23762209072917874016222680172199606531)}
...
def test_toBase64(rsa_key):
    assert rsa_key.toBase64() == b"eyJuIjogImQ3MWM2NjAxM2VhZWU0ODUyZmU3Nzk3ZTRlMmFlZWVkIiwgImUiOiAiMTAwMDEiLCAiZCI6ICIyM2NhYTk1YzRlYWEzYTAyNzMwZjk2NWE4YTM5MDNkMSJ9"

def test_fromBase64(rsa_key, empty_rsa_key):
    empty_rsa_key.fromBase64("eyJuIjogImQ3MWM2NjAxM2VhZWU0ODUyZmU3Nzk3ZTRlMmFlZWVkIiwgImUiOiAiMTAwMDEiLCAiZCI6ICIyM2NhYTk1YzRlYWEzYTAyNzMwZjk2NWE4YTM5MDNkMSJ9")
